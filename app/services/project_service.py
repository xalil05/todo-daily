...
SEED_PROJECTS = [
    {
        ...
        "short_name": "🏦 Khady",
        "description": "Automatisation de dossiers d'entreprise bankables — études marché, finance, juridique, risque. SaaS piloté par Khady-Consulting.",
        "category": "saas",
        "status": "active",
        "color": "#6366f1",
        "icon": "🏦",
    ...
    },
    {
        ...
        "slug": "bugcrush",
        "short_name": "🐛 Ahmada",
        "description": "Pipeline de débogage automatisé SaaS — Triage → Reproduction → Diagnostic → Correction → Sécurité. Piloté par Ahmada.",
        "category": "saas",
        "status": "active",
        "color": "#ef4444",
        "icon": "🐛",
    ...
    },
    {
        ...
        "slug": "secureshield",
        "short_name": "🛡️ Codou",
        "description": "Audit cybersécurité SaaS — OSINT, pentest, forensique, conformité RGPD/ISO, monitoring. Piloté par Codou-Security.",
        "category": "saas",
        "status": "active",
        "color": "#10b981",
        "icon": "🛡️",
    ...
    },
    {
        ...
        "slug": "melo-studio",
        "short_name": "🎨 Melo",
        "description": "Direction artistique SaaS — branding, pitch decks, contenu social, génération d'images IA. Piloté par Melo.",
        "category": "saas",
        "status": "active",
        "color": "#8b5cf6",
        "icon": "🎨",
    ...
    },
    {
        ...
        "slug": "prompto",
        "short_name": "⚡ Prompto",
        "description": "Prompt Factory SaaS — transforme un brief en prompt prêt à copier-coller. Piloté par Exprompt.",
        "category": "saas",
        "status": "draft",
        "color": "#f59e0b",
        "icon": "⚡",
